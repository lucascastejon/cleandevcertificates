...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.cpf'
        db.alter_column(u'core_person', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Person.cpf'
        db.alter_column(u'core_person', 'cpf', self.gf('django.db.models.fields.CharField')(default='', max_length=20, unique=True))
